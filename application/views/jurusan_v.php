<div id="content">
    ...
    <div class="container-fluid">
        ...
        <!-- Page Heading -->
        <h1 class="h3 mb-2 text-gray-800 mt-5">Jurusan</h1>
        ...
        <div class="card shadow mb-4">
            ...
            <div class="card-body">
                <div class=" d-sm-flex align-items-center justify-content-between">
                    <h5>Data Jurusan</h5>
                    <div class="row">
                        <a href="#" type="button" class="btn btn-primary btn-sm add">Tambah Jurusan</a>
                    </div>
...
<script>
    $(document).ready(function() {
        ...
        table = $('#tabel').DataTable({
            ...
            "ajax": {
                "url": "<?php echo base_url(); ?>jurusan/get",
                "type": "POST"
            },
    ...
    $(".add").click(function() {
        ...
        $('#add').modal('show');
        $('#info').hide();
        $('#status').html('Tambah Jurusan');
        $('#simpan').html('Tambah Jurusan<i class="fas fa-save text-white ml-2"></i>');
    });
    $(".save").click(function() {
